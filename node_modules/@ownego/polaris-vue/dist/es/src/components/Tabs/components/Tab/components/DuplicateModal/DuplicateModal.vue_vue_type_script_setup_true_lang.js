...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  emits: ["close", "click-primary-action", "click-secondary-action"],
  setup(__props, { emit: __emit }) {
    ...
    const isPrimaryActionDisabled = computed(() => {
      return props.isModalLoading || hasSameNameError.value || !model.value || model.value.length > MAX_VIEW_NAME_LENGTH;
    });
...
//# sourceMappingURL=DuplicateModal.vue_vue_type_script_setup_true_lang.js.map
